...
import LemonadeFinanceModalBuy from "../LemonadeFinance/LemonadeFinanceModal/LemonadeFinanceModalBuy";
import MyTimer from "./LemonadeFinanceModal/MyTimer";
import LemonNetworkTimer from "./LemonadeFinanceModal/MyTimerLemonNetwork";
    ...
    <div className="container">
      ...
      <div className="section-head section-head-s4 wide-auto-sm text-center">
        <h2
          ...
          data-delay=".1"
        >
          <span className="font-weight-normal"> </span>Lemonade{" "}
          <span className="font-weight-normal">Finance</span>
        </h2>
      </div>
      ...
      <div className=" nk-block-text-wrap">
          ...
          >
            <div className="d-flex  flex-column ">
              ...
              <div className="d-flex align-items-center">
                <img className="logo-water" src={logo} alt="" />
            ...
            <div className="d-flex align-items-center flex-column ">
              ...
              <span className="value-text">
                60% <img className="gauge-logo" src={logo} alt="" />
              </span>
              <div
              ...
              >
                <span>
                  ...
                  <img style={{ width: "35px" }} src={logo} alt=""></img>{" "}
                </span>
                <span>
                  TVL:
        ...
        <div className="d-flex align-items-center flex-column justify-content-between">
          ...
          >
            ...
            <div className="d-flex align-items-center flex-column ">
              ...
              <span className="value-text">
                87,7% <img className="gauge-logo" src={logo} alt="" />
              </span>
              <div
                style={{ marginBottom: "20px" }}
                className="gauge-card d-flex flex-column "
        ...
        <div className="d-flex flex-column my-5">
          <div className="d-flex flex-column">
            <h1 className="modal-btn-title">Want to Purchase LMN?</h1>
            <div className="d-flex flex-column justify-content-between ">
              <span className="modal-btn-text text-justify">
                Due to the big Community aim for being able to purchase more LMN
                and participate with higher shares once Lemonade is released we
                open the possibility for our investors to purchase more LMN.
                Those are automatically received, there is no Vesting or LockUp
                periode. Get your LMN and start earning with Lemonade Finance in
                our anticipated Vaults.
              </span>
              <button
                className="modal-btn-top"
                onClick={() => {
          ...
          <div className="d-flex flex-column">
            <h1 className="modal-btn-heading">Not Glad?</h1>
            <div className="d-flex flex-column justify-content-between">
              <span className="modal-btn-text text-justify">
                We don't want angry members along the Lemon Network Ecosystem
                Development. We need a strong community with the aim to change
                the world, change the actual paradigm so we USERS can get the
                power back. So if you think that you do not belong to this new
                an innovative project you can click and{" "}
                <span
...
export default LemonadeFinance;
